...
class Cliente(Base):
    ...
    quantidade_dependentes = models.PositiveIntegerField(null=True, blank=True, default=0)
    recebe_auxilio = models.BooleanField(default=False)
    total_renda = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
